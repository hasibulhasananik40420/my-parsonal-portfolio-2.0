...
const Amazon = () => {
  return (
    ...
    className='w-full'
>
    <h1 className='flex gap-1 font-titleFont text-xl font-medium'>Web Developer
        <span className='text-textGreen font-titleFont font-medium text-xl'>@Amazon</span></h1>
    <p className='text-sm font-titleFont text-textDark font-medium mt-1'>Jan 2023 - present</p>
