...
const ReactDB = () => {
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            className='w-full'
        >
            <h1 className='flex gap-1 font-titleFont text-xl font-medium'>Developer <span className='text-textGreen font-titleFont font-medium text-xl'>@Ayana network</span></h1>
            <p className='text-sm  text-textDark font-medium mt-1'>March 2023 - present</p>
